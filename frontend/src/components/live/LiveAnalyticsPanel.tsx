...
const defaultAnalytics = [
  { id: "fps", label: "Global Frame Rate", value: "25 fps", delta: "+2.4%", deltaType: "up" as const, accent: "#22C55E" },
  { id: "latency", label: "Pipeline Latency", value: "14 ms", delta: "-1.8%", deltaType: "down" as const, accent: "#3B82F6" },
  { id: "detected", label: "Active Detections", value: "6 targets", delta: "+15%", deltaType: "up" as const, accent: "#F97316" },
  { id: "streams", label: "Online Cameras", value: "6 / 6", delta: "100%", deltaType: "up" as const, accent: "#22C55E" },
];
